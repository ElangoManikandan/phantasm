...
async function handleRegister(req, res) {
    ...
    try {
        ...
        await pool.promise().query('UPDATE users SET qr_code_id = ? WHERE id = ?', [qr_code_id, userId]);
...
async function handlePasswordReset(req, res) {
    ...
    try {
        ...
        const result = await pool.promise().query('UPDATE users SET password = ? WHERE email = ?', [hashedPassword, email]);
